...
so after some research i found that it does expose a MQTT and REST API so its a no brainer i will use Go - my favorite programming language for it

I will keep the blog updated if i complete it